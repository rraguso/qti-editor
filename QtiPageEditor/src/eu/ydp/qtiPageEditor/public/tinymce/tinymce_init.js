...
tinyMCE.init({  
	...
	theme_advanced_buttons3 : "insertgap,insertinlinechoice,insertchoicesection,insertordersection,insertmatchsection,|,fileuploadlib_image,addvideo,|,insertcomment,|,enablechangestracking,disablechangestracking,|,tablecontrols,|,anchor,|,code,|,help",
