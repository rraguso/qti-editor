(function() {
			...
			ed.addCommand('mcePlayPause', function(ui, data) {
				...
				var browseCallback = {
					...
					onBrowseComplete : function(filePath, title) {
						...
						var playpausetag = '<!-- <audioPlayer src="' + fromPath + '/' + filePath + '" /> --><img id="mcePlayPause" src="/tools/qtitesteditor/tinymce/tiny_mce/plugins/playpause/img/playpause.png" />';
	...
	tinymce.PluginManager.add('playpause', tinymce.plugins.playPausePlugin);
})();
