...
tinyMCE.init({
	...
	*/
	...
	//,formatselect   ,anchor,|
	theme_advanced_buttons1 : "save,newdocument,print,preview,|,fontselect,fontsizeselect,|,bold,italic,underline,strikethrough,|,justifyleft,justifycenter,justifyright,justifyfull,|,help",
