...
var choiceDialog = {
	...
	insertChoiceSection : function(form) {
		...
		if(adding == 1) {
			var choiceSection = '<p>&nbsp;</p><!-- </qy:tag> --><!-- <qy:tag name="exercise"> --><!-- <choiceInteraction responseIdentifier="' + identifier + '" shuffle="' + String(shuffle) + '" maxChoices="' + String(maxChoices) + '"> --><div id="choiceInteraction" class="mceNonEditable" style="border: 1px solid blue; color: blue; padding: 5px; background-color: #f0f0f0;">';
			...
			choiceSection += '</div><!-- end of choiceInteraction --><!-- </qy:tag> --><!-- <qy:tag name="text"> -->';
